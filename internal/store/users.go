...
func (s *Store) EnsureDefaultEvent(ctx context.Context, name string) (Event, error) {
...
func (s *Store) UserByName(ctx context.Context, eventID, name string) (User, error) {
...
func (s *Store) VotesCast(ctx context.Context, userID string) (int, error) {
	var n int
